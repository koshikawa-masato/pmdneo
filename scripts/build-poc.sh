...
make PMDNEO_CHIP="$PMDNEO_CHIP" PMDNEO_USE_PMDDOTNET="${PMDNEO_USE_PMDDOTNET:-0}" TEST_MODE_AXIS_G_INT="${PMDNEO_AXIS_G_INT:-0}" TEST_MODE_MUTE_FIXTURE="${PMDNEO_MUTE_FIXTURE:-0}" TEST_MODE_FADE_FIXTURE="${PMDNEO_FADE_FIXTURE:-0}" TEST_MODE_V2_ENTRY_FIXTURE="${PMDNEO_V2_ENTRY_FIXTURE:-0}" PMDNEO_NO_FADE="${PMDNEO_NO_FADE:-0}" STANDALONE_Z80_SRC=standalone_test.s -W standalone_test.s -W main.c poc
