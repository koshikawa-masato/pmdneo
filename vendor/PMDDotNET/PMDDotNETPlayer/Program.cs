...
namespace PMDDotNET.Player
{
    class Program
    {
        ...
        private static readonly uint SamplingRate = 55467;
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (drv.GetStatus() <= 0)
                    {
                        if (drv.GetStatus() == 0)
                        {
                            System.Threading.Thread.Sleep((int)(latency * 2.0));
                        }
                        break;
                    }
        ...
        private static void OPNAWaitSend(long elapsed, int size)
        {
            switch (device)
            {
                ...
                case 1://GIMIC
                    ...
                    int m = Math.Max((int)(size / 20 - elapsed), 0);
                    Thread.Sleep(m);
        ...
        private static void RealCallback()
        {
            ...
            try
            {
                while (!trdClosed)
                {
                    ...
                    if (el1 - o >= step)
                    {
                        if (el1 - o >= step * SamplingRate / 100.0)
                        {
                            do
                            {
                                o += step;
                    ...
                    if (el1 - oPPS >= stepPPS)
                    {
                        if (el1 - oPPS >= stepPPS * PPSSamplingRate / 100.0)
                        {
                            do
                            {
                                oPPS += stepPPS;
