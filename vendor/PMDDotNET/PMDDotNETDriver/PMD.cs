...
namespace PMDDotNET.Driver
{
    public class PMD
    {
        ...
        public Func<object> lfowave_set()
        {
            ...
            //IDE向け
            ChipDatum cd = new ChipDatum(-1, -1, -1);
            cd.addtionalData = new MmlDatum(-1, enmMMLType.Lfo, pw.cmd.linePos
                , (int)1 //wave
                , (byte)pw.partWk[r.di].lfo_wave
                , (byte)pw.partWk[r.di]._lfo_wave
                );
            WriteDummy(cd);
        ...
        public Func<object> extend_psgenvset()
        {
            ...
            //IDE向け
            ChipDatum cd = new ChipDatum(-1, -1, -1);
            cd.addtionalData = new MmlDatum(-1, enmMMLType.Envelope, pw.cmd.linePos
                , (int)1
                , (byte)pw.partWk[r.di].eenv_ar
                , (byte)pw.partWk[r.di].eenv_dr
                , (byte)pw.partWk[r.di].eenv_sr
                , (byte)pw.partWk[r.di].eenv_rr
                , (byte)pw.partWk[r.di].eenv_sl
                , (byte)pw.partWk[r.di].eenv_al
                );
            WriteDummy(cd);
        ...
        public Func<object> _lfoswitch()
        {
            ...
            //IDE向け
            ChipDatum cd = new ChipDatum(-1, -1, -1);
            cd.addtionalData = new MmlDatum(-1, enmMMLType.LfoSwitch, pw.cmd.linePos
                , (int)(sbyte)pw.partWk[r.di].lfoswi
                );
            WriteDummy(cd);
        ...
        public Func<object> lfoset()
        {
            ...
            cd.addtionalData = new MmlDatum(-1, enmMMLType.Lfo, pw.cmd.linePos
                , (int)0
                , (byte)pw.partWk[r.di].delay
                , (byte)pw.partWk[r.di].speed
                , (sbyte)pw.partWk[r.di].step
                , (byte)pw.partWk[r.di].time
                , (byte)pw.partWk[r.di]._delay
                , (byte)pw.partWk[r.di]._speed
                , (sbyte)pw.partWk[r.di]._step
                , (byte)pw.partWk[r.di]._time
                );
            WriteDummy(cd);
