...
| gate 4 | static | 既存 SRAM layout 0xF820-0xFD38 不変 (= `part_workarea` 0xF820 + `PART_COUNT` 20 / `PART_WORKAREA_SIZE` 64 / `driver_pne_filename_buf` 0xFD20 / `driver_pne_filename_adr_word` 0xFD30 / `driver_pne_sample_table_id` 0xFD32 / `ppc_scratch_start_lsb` 0xFD33 / `audition_frame_counter_lsb` 0xFD37 = ADR-0006/0022/0023/0048 layout shift なし) |
...
- `verify-axis-b-sram-placement.sh` 6 gate 全 PASS (= 39th session 実行確認、 EXIT 0)
  ...
  - gate 4 = 既存 SRAM layout 0xF820-0xFD38 不変 (= part_workarea 0xF820 + PART_COUNT/SIZE + 0xFD20/0xFD30/0xFD32/0xFD33/0xFD37)
