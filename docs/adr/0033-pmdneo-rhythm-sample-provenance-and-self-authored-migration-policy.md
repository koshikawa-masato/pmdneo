...
- AI 役割 3 = **patch-spec → `.fxp` allowlist patching bridge** (= ξ 起票 / π refine、 XML element name allowlist patching、 toolchain implementation、 「bridge, not full synthesizer patch compiler」)
